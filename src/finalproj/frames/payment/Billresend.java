...
public class Billresend extends javax.swing.JFrame {
    ...
    public Billresend() {
        logger = Logger.getLogger(Billresend.class.getName());
        ...
        if (flag == false) {
            ...
            if (!(combo_list.getSelectedItem().toString().equals(""))) {
                try {
                    ...
                    savePath = jarDir + "\\bills\\" + combo_list.getSelectedItem().toString();
                    sendmail();
    ...
    private void sendmail() {
        ...
        try {
            ...
            logger.info("Method call: mailsent");
    ...
    private void fillbill() {
        logger.info("Method call: fillbill");
