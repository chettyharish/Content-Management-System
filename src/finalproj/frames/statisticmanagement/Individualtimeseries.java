...
public class Individualtimeseries extends javax.swing.JFrame {
    ...
    public Individualtimeseries() {
        logger = Logger.getLogger(Individualtimeseries.class.getName());
    ...
    private void initComponents() {
        ...
        button_generate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/finalproj/frames/icons/linesfull.png"))); // NOI18N
                    ...
                    .addGroup(main_panelLayout.createSequentialGroup()
                        ...
                        .addGroup(main_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, main_panelLayout.createSequentialGroup()
                                ...
                                .addGap(48, 48, 48))
                            .addComponent(main_label, javax.swing.GroupLayout.Alignment.TRAILING)))
        ...
        if (!(combo_customerid.getSelectedItem().toString().equals(""))) {
            if (!(combo_individualid.getSelectedItem().toString().equals(""))) {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Parse Exception in final action" + ex.getMessage());
                            logger.fatal("Fatal error", ex);
                        }
                ...
                try {
                    ...
                    CodeSource codeSource = Individualtimeseries.class.getProtectionDomain().getCodeSource();
                    ...
                    String savePath = jarDir + "\\images\\" + "IndividualTS_" + Dategenerator.getCurrentDatepath() + ".png";
                ...
                logger.error("Individual missing");
            }
        } else {
